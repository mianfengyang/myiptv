...
# 将结果写入文件
with open("iptv-org_results.txt", 'w', encoding='utf-8') as file:
    for result in results:
        channel_name, channel_url, resolution, speed = result
        file.write(f"{channel_name},{channel_url},{resolution},{speed}\n")

with open("iptv-org_speed.txt", 'w', encoding='utf-8') as file:
    for result in results:
        channel_name, channel_url, resolution, speed = result
...
with open("iptv-org-tvlist.txt", 'w', encoding='utf-8') as file:
    channel_counters = {}
...
with open("iptv-orgtv.m3u", 'w', encoding='utf-8') as file:
    channel_counters = {}
    file.write('#EXTM3U\n')
    for result in results:
        channel_name, channel_url, resolution, speed = result
